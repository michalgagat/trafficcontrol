...
public class ZoneSignerImpl implements ZoneSigner {
	...
	public List<Record> signZone(final Name name, final List<Record> records, final List<DnsSecKeyPair> kskPairs, final List<DnsSecKeyPair> zskPairs,
								 final Date inception, final Date expiration, final boolean fullySignKeySet, final int digestId, final ConcurrentMap<RRSIGCacheKey, ConcurrentMap<RRsetKey, RRSIGRecord>> RRSIGCache) throws IOException, GeneralSecurityException {
